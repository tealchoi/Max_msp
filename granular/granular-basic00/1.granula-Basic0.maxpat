...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 48.0, 298.0, 184.0, 68.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 182.0, 133.0, 150.0, 20.0 ],
					"text" : "attrui"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 23.0, 52.0, 152.0, 51.0 ],
					"text" : "granula"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1088.0, 52.0, 197.0, 51.0 ],
					"text" : "Hamming"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 1088.0, 126.0, 370.0, 499.0 ],
					"pic" : "hamming.png"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 50.0, 298.0, 184.0, 68.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 26.0, 133.0, 150.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 26.0, 436.0, 45.0, 45.0 ]
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"patching_rect" : [ 169.0, 237.0, 61.0, 23.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 104.0, 423.0, 150.0, 22.0 ],
									"text" : "0~1로 맵핑해준다. "
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "signal", "signal" ],
									"patching_rect" : [ 182.0, 450.0, 61.0, 23.0 ],
									"rnbo_classname" : "sample~",
									"rnbo_extra_attributes" : 									{
										"boundmode" : "wrap",
										"interp" : "linear",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "signal", "signal" ],
									"patching_rect" : [ 104.0, 450.0, 60.0, 23.0 ],
									"rnbo_classname" : "peek~",
									"rnbo_extra_attributes" : 									{
										"boundmode" : "ignore",
										"interp" : "none",
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 394.0, 287.0, 43.0, 23.0 ],
									"rnbo_classname" : "out~",
									"rnbo_extra_attributes" : 									{
										"meta" : "",
										"comment" : ""
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 390.600005626678467, 168.0, 51.0, 23.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 394.0, 243.0, 64.0, 23.0 ],
									"rnbo_classname" : "hamming~",
									"rnbo_serial" : 1,
									"rnbo_uniqueid" : "hamming~_obj-17",
									"text" : "hamming~"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 390.600005626678467, 115.800000429153442, 204.0, 23.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 169.0, 286.0, 43.0, 23.0 ],
									"rnbo_classname" : "out~",
									"rnbo_extra_attributes" : 									{
										"meta" : "",
										"comment" : ""
...
,
					"patching_rect" : [ 26.0, 200.0, 88.0, 22.0 ],
					"rnboattrcache" : 					{
						"phasorFreq" : 						{
							"label" : "phasorFreq",
							"isEnum" : 0,
