...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 747.0, 402.5, 184.0, 68.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 858.0, 287.5, 184.0, 68.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 781.0, 119.0, 150.0, 20.0 ],
					"text" : "attrui"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 1481.0, 126.0, 558.0, 314.0 ],
					"pic" : "Macintosh HD:/Users/kimsunghoon/Library/CloudStorage/Dropbox/0.2023Tech+study/1.granula-Baisc/img-granula/Gaussian-Hann-and-Blackman-window-functions.png"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 15.0, 550.0, 555.0, 75.0 ],
					"text" : "sample을 짤라오면 양끝에 시작 , 끝점이 0이 아니무로 Hamming에서 0으로 만들어주는 작업을 해준다. 그리고 그것을 계속반복하게 하는것. "
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "jit_matrix" ],
					"patching_rect" : [ 15.0, 114.0, 559.0, 415.0 ],
					"pic" : "Macintosh HD:/Users/kimsunghoon/Library/CloudStorage/Dropbox/0.2023Tech+study/1.granula-Baisc/img-granula/IMG_87B96EB67ACD-1.jpeg"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 23.0, 52.0, 199.333334743976593, 51.0 ],
					"text" : "granular"
				}
...
, 			{
				"box" : 				{
					...
					"pic" : "Macintosh HD:/Users/kimsunghoon/Library/CloudStorage/Dropbox/0.2023Tech+study/1.granula-Baisc/img-granula/hamming.png"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 649.0, 284.0, 184.0, 68.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 625.0, 119.0, 150.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 625.0, 422.0, 45.0, 45.0 ]
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 211.0, 133.0, 29.5, 23.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 222.5, 379.0, 65.0, 23.0 ],
									"rnbo_classname" : "blackman~",
									"rnbo_serial" : 1,
									"rnbo_uniqueid" : "blackman~_obj-16",
									"text" : "blackman~"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 102.899994373321533, 379.0, 64.0, 23.0 ],
									"rnbo_classname" : "hamming~",
									"rnbo_serial" : 2,
									"rnbo_uniqueid" : "hamming~_obj-14",
									"text" : "hamming~"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 102.899994373321533, 344.0, 150.0, 22.0 ],
									"text" : "window 계열 에서 "
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 230.0, 163.0, 50.0, 23.0 ],
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 159.0, 163.0, 50.0, 23.0 ],
									"rnbo_classname" : "number",
									"rnbo_extra_attributes" : 									{
										"maximum" : "<none>",
										"minimum" : "<none>",
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 104.0, 138.0, 24.0, 24.0 ],
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 104.0, 202.0, 117.0, 23.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 104.0, 287.0, 43.0, 23.0 ],
									"rnbo_classname" : "out~",
									"rnbo_extra_attributes" : 									{
										"meta" : "",
										"comment" : ""
...
,
					"patching_rect" : [ 625.0, 186.0, 88.0, 22.0 ],
					"rnboattrcache" : 					{
						"phasorFreq" : 						{
							"label" : "phasorFreq",
							"isEnum" : 0,
...
,
		"dependency_cache" : [ 			{
				"name" : "Gaussian-Hann-and-Blackman-window-functions.png",
				"bootpath" : "~/Library/CloudStorage/Dropbox/0.2023Tech+study/1.granula-Baisc/img-granula",
				"patcherrelativepath" : "./img-granula",
				"type" : "PNG",
				"implicit" : 1
			}
, 			{
				"name" : "IMG_87B96EB67ACD-1.jpeg",
				"bootpath" : "~/Library/CloudStorage/Dropbox/0.2023Tech+study/1.granula-Baisc/img-granula",
				"patcherrelativepath" : "./img-granula",
				"type" : "JPEG",
				"implicit" : 1
